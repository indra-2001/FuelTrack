          ...
          <div class="card-body">
            ...
            <div class="table-responsive">
              <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
                ...
                <tbody>
                  <?php
                  $stmt = $conn->prepare(" SELECT fs.*, fc.name AS fuel_name
    FROM fuel_tbl fs
    JOIN fuel_category fc ON fs.fuel_category_id = fc.id
    WHERE fs.delete_status = '0' ");
                  $stmt->execute();
                  ...
                  foreach ($record as $key) { ?>
                    <tr>
                      ...
                      <td>
                        <!-- <a href="#" onclick="editForm(event, <?php //echo $key['id']; ?>,'edit_fuel.php')"
